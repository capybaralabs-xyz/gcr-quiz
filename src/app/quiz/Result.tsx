    ...
    return (
        <div className={cn("w-[288px] mt-[91px] tablet:w-[385px] laptop:w-[698px] desktop:w-[1009px]")}>
            <div className="overflow-hidden rounded-t-md border-2 border-gray-400 bg-[#A8A8A8] shadow-lg">
                ...
                <span className="text-[10px] font-diatype-mono-bold tablet:text-[20px] tablet:leading-[20px] tablet:font-diatype-mono">Results</span>
                ...
                <div className="relative px-3 py-5 border-t-0 border-r-4 border-b-4 border-l-4 border-[#989898] b flex flex-col items-center bg-[#E1E1E1]">
                    ...
                    <p className='mt-[10px] text-lg font-diatype-mono-bold tablet:text-[31px] tablet:leading-[41px]'>{ data.character }</p>
                    ...
                    <button onClick={shareOnX} className='mt-[10px] w-full h-[105px] rounded-[20px] bg-black font-old-english text-white text-[35px] font-medium tablet:h-[121px] tablet:text-[50px] tablet:leading-[65px]
                    laptop:h-[285px] laptop:text-[112px] laptop:leading-[195px] desktop:text-[155px] desktop:leading-[195px]
                    active:translate-y-0.5 active:bg-gray-900 transition-transform duration-75'>
                        repost on X
                    </button>
                </div>
            </div>
            ...
            <div className="overflow-hidden rounded-t-md border-2 border-gray-400 bg-[#E1E1E1] shadow-lg">
                ...
                <div className="relative px-3 py-5 border-t-0 border-r-4 border-b-4 border-l-4 border-[#A8A8A8] b flex flex-col items-center  ">
                    ...
                    <picture>
                        ...
                        <p className='text-white text-[12px] leading-16 font-diatype-mono font-normal	text-center mt-[10px] tablet:py-8 laptop:text-[20px] laptop:leading-[26.52px]
                        laptop:py-3'>
                            We know life is tough in trenches, here is your Peopleswap whitelist. Finally you are indeed early, congrats!
                        </p>
                    </div>
                    <button 
                        className='mt-[10px] w-full h-[79px] rounded-[20px] font-diatype-mono text-white text-[19px] font-medium flex items-center justify-between px-5 bg-[#5A5A5A]  active:translate-y-0.5 transition-transform duration-75 '
                    ...
                    active:translate-y-0.5 active:bg-gray-50 transition-transform duration-75'>
                        Enter Website
                    </button>
                </div>
            </div>
